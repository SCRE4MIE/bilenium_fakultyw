...
# Project
from api.views import AddRating, WalksList, TrainersWalksList, CreateTrainersWorksDays, UpdateTrainersWorksDays
...
urlpatterns = [
    ...
    path('update-trainer-work-days/', UpdateTrainersWorksDays.as_view(), name='update_trainer_work_days'),
]
